...
from .jefferson import initialize_jefferson_request
from .jefferson import finalize_jefferson_response
...
def setup_middlewares(app):
    ...
    # request middleware
    app.request_middleware.append(initialize_jefferson_request)
