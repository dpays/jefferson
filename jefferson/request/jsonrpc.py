...
class JSONRPCRequest:
    ...
    def __init__(self,
        ...
        self.jefferson_request_id = jefferson_request_id
    ...
    def upstream_headers(self) -> dict:
        headers = {'x-jefferson-request-id': self.jefferson_request_id}
    ...
    def upstream_id(self) -> int:
        return int(self.jefferson_request_id) + self.batch_index
...
def from_http_request(http_request, batch_index: int, request: SingleRawRequest):
    ...
    return JSONRPCRequest(_id,
                          ...
                          http_request.jefferson_request_id,
                          batch_index,
                          original_request,
                          timings)
