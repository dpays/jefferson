...
import pytest
from jefferson.errors import InvalidNamespaceError
from jefferson.errors import InvalidNamespaceAPIError
from jefferson.urn import _empty
from jefferson.urn import from_request
from jefferson.urn import _parse_jrpc
...
def test_parse_jrpc_namespace_is_dpayd(dpayd_request_and_response):
    req, resp = dpayd_request_and_response
    result = _parse_jrpc(req)
    assert result['namespace'] == 'dpayd'
