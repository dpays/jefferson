...
from jefferson.cache import CacheGroupItem
from jefferson.cache import SpeedTier
from jefferson.cache.cache_group import CacheGroup
...
jrpc_resp_1 = {
    "id": 2,
    "result": {
        "previous": "000000011b5056ef5b610531031204f173aef7a8",
        "timestamp": "2018-09-04T16:36:33",
        "witness": "dpay",
        "transaction_merkle_root": "0000000000000000000000000000000000000000",
        "extensions": [],
        "witness_signature": "1f39a1540cb5853377aa40c051ebde3fcc5a7b96d5b0881ed71ff10b8fcb6844711ed4920954ac80626486e49ba9ade4844813746590ab092bfc7ab1bca6a071b5",
        "transactions": [],
        "block_id": "00000002c4809dadc4e67ac65e57c9530ab16782",
...
def test_cache_group_is_complete_response(dpayd_request_and_response):
    req, resp = dpayd_request_and_response
    req = jsonrpc_from_request(dummy_request, 0, req)
